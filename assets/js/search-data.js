...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Complete list of Yue&#39;s publications in reverse chronological order.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Repositories",
          description: "A collection of my GitHub repositories and collaborations.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-boom-one-paper-accepted-by-ieee-ra-l",
