...
[//]: # (My desired research directions include but not limited to:)
- **_Data_: Scalable Robot Data (e.g., Demonstrations) Collection**. 
...
- **_Controller_: Scalable Robot Policy Learning from Videos**.
...
- **_Deployment_: Human-in-the-loop Robot Behaviors Correction**.
...
<span style="color:red">**I eagerly anticipate any forms of opportunities for collaboration within the realm of ML and Robotics :) Feel free to reach me most reliably through email!**</span>
...
[//]: # (The problem I'm caring about for now is related to )

[//]: # (1. How the robot can learn from large-scaled cross-embodiment data, such as in-the-wild human videos?)

[//]: # (2. How to more efficiently collect or even generate robot data?)

[//]: # (3. How the human should get involved in robot learning/deployment? For instance, when the robot knows it's uncertain about the environment and needs human help? If human get involved, what modality &#40;e.g., language, small demonstration&#41; should the human provide to help the robot?)
